  ...
  return (
    <div style={{ minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0a0a0c', direction: 'rtl' }}>
      <motion.div
        ...
        style={{ width: '100%', maxWidth: 420, padding: '2.5rem', background: '#0a0a0a', borderRadius: 24, boxShadow: '0 24px 60px rgba(0,0,0,0.4)' }}
      >
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1rem' }}>
            <div style={{ width: 64, height: 64, borderRadius: 18, background: 'rgba(14,165,233,0.1)', border: '1px solid rgba(14,165,233,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Lock size={30} color="#0ea5e9" strokeWidth={1.8} />
            </div>
          </div>
          <h1 style={{ fontSize: '1.6rem', fontWeight: 900, color: '#FFFFFF', marginBottom: '0.4rem' }}>ألمظ استور</h1>
          <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.9rem' }}>تسجيل الدخول للوحة التحكم</p>
        </div>
